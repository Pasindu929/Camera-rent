...
public class UserLoginTest {
    ...
    public void testUserLogin() {
        driver.get("http://localhost:3000/login"); // Replace with your login page URL
        ...
        WebElement submitButton = wait.until(ExpectedConditions.elementToBeClickable(By.id("loginButton")));
